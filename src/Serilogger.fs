...
module internal Serilogger =
    ...
    let private loggerConfig = Configuration.mailerConfig.Logging
    let [<Literal>] private OutputTemplate = "{Timestamp:yyyy-MM-dd HH:mm:ss.fff zzz} [{Level}] {Message}{NewLine}{Exception}"
