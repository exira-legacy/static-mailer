...
let project = "Exira.StaticMailer"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Exira.StaticMailer is a REST endpoint running in a Windows Service to enable static sites to easily send mail"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Exira.StaticMailer is a REST endpoint running in a Windows Service to enable static sites to easily send mail"

// List of author names (for NuGet package)
let authors = [ "exira" ]

// Tags for your project (for NuGet package)
let tags = "owin rest topshelf f#"

// File system information
let solutionFile  = "static-mailer.sln"
