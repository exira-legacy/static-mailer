...
let referenceBinaries = [ "static-mailer\\static-mailer.exe" ]
// Web site location for the generated documentation
let website = "/static-mailer"

let githubLink = "http://github.com/exira/static-mailer"

// Specify more information about your project
let info =
  [ "project-name", "static-mailer"
    "project-author", "exira"
    "project-summary", "Exira.StaticMailer is a REST endpoint running in a Windows Service to enable static sites to easily send mail"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Exira.StaticMailer" ]
